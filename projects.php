			...
			<div class="row">
				...
				<div id="touch_gallery">
					<div class="grid_4">
						...
						<article>
							<h4>Aranyszarvas </h4>
							<p>Az <span>Aranyszarvas Panzió és Étterem</span> az Arborétum közvetlen szomszédságában található. A közvetlen vízparton elhelyezkedő szálláshely bővítésének keretében készítettük el a 3. számú apartmanházat, melyben 20 szobát, és ugyanannyi fürdőszobát alakítanunk ki.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Bordűr Hotel</h4>
							<p>A <span>Bordűr Wellness Hotel Superior és Szőnyegmúzeum</span> felújításában fővállakozóként vettünk részt. A 150 éves szőnyeggyárként üzemelő épület felújítása 2024-ben fejeződőtt be. A közel 4.5 milliárdos beruházás 3 évig tartott.  </p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Liget Hotel</h4>
							<p>A szarvasi Erzsébet Ligetben található <span>Liget Wellness és Konferencia Hotel</span> apartmanjainak kialakítását végeztük el. Az épületeket az alapoktól a belső design kialakításáig mi végeztük. 8 db apartman készült, apartmanonként 8 fő befogadására alkalmas.</p>
						</article>
					</div>
					<div class="grid_4">
